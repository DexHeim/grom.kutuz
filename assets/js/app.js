(() => {
  ...
  const activities = [
    ...
    {
      id: 'patrol',
      title: 'Патруль по городу (30 минут)',
      points: 30,
      proof: 'Скриншот начала патруля, каждые 15 минут и окончания патруля'
    },
    {
      id: 'training',
    ...
    {
      id: 'reinforced_patrol',
      title: 'Усиленный патруль по военным объектам (45 минут)',
      points: 45,
      proof: 'Доклады и скриншоты начала, каждые 15 минут и окончания патруля'
    },
    {
      id: 'duty_unit',
      title: 'Дежурное подразделение (60 минут)',
      points: 60,
      proof: 'Доклады и скриншоты заступления, продолжения и сдачи наряда ДП'
    },
    {
      id: 'duty_unit_base',
      title: 'Дежурное подразделение',
      points: 40,
      proof: 'Доклады и скриншоты дежурного подразделения'
    },
    {
      id: 'arrest',
      title: 'Арест',
  ...
  const promotionSteps = [
    {
      ...
      points: 350,
      requirements: [
        'Патруль по городу (30 минут)',
        'Запрос роли в моссетях',
        'Прикрепить личное дело',
        { text: 'Запросить позывной', href: 'faq.html#callsign-request' }
      ]
    },
    {
      title: 'Ст. Сержант → Старшина',
      points: 450,
      requirements: ['2 поставки', 'Пост дежурное подразделение (60 минут)']
    },
    {
      title: 'Старшина → Прапорщик',
      points: 550,
      requirements: [
        'Патруль по городу (60 минут)',
        { text: 'Сдать практику задержания у Инструктора или у СС ОСН «Гром»', href: 'https://discord.com/channels/1465392165453828138/1495112904511459458' }
      ]
    },
    {
      title: 'Прапорщик → Ст. Прапорщик',
      points: 650,
      requirements: ['5 гос.поставок', 'Дежурное подразделение (120 минут)']
    },
    {
    ...
    },
    {
      ...
      points: 1000,
      requirements: ['2 ареста', '2 штрафа', '10 гос.поставок', 'Патруль по городу (60 минут)']
    },
    {
      title: 'Лейтенант → Ст. Лейтенант',
      points: 1300,
      requirements: ['3 ареста', '15 гос.поставок', '4 штрафа', 'Усиленный патруль по военным объектам (45 минут)']
    },
    {
      title: 'Ст. Лейтенант → Капитан',
      points: 1500,
      requirements: ['3 ареста', '20 гос.поставок', 'Дежурное подразделение (60 минут)', 'Усиленный патруль по военным объектам (90 минут)']
    }
  ];
